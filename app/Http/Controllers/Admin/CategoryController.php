...
class CategoryController extends Controller
{
    ...
    public function store(StoreCategoryRequest $request): RedirectResponse
    {
        ...
        $category = DB::transaction(function () use ($validated, $request): Category {
            ...
            ActivityLog::record('category.created', $category, [
                'name' => $category->name,
                'slug' => $category->slug,
            ]);
    ...
    public function update(UpdateCategoryRequest $request, Category $category): RedirectResponse
    {
        ...
        DB::transaction(function () use ($category, $validated, $request): void {
            ...
            ActivityLog::record('category.updated', $category, [
                'name' => $category->name,
