...
class PortalController extends Controller
{
    ...
    public function home(): Response
    {
        ...
        $heroSettings = Setting::query()
            ->whereIn('key', [
                'hero_book_1_image', 'hero_book_1_title', 'hero_book_1_link',
                'hero_book_2_image', 'hero_book_2_title', 'hero_book_2_link',
                'hero_book_3_image', 'hero_book_3_title', 'hero_book_3_link',
            ])
            ->pluck('value', 'key');
        ...
        $heroBooks = [
            'book_1' => [
                'image' => $heroSettings->get('hero_book_1_image', '/images/cover-1.jpg'),
                'title' => $heroSettings->get('hero_book_1_title', 'Buku Modul PERKEMI 1'),
                'link' => $heroSettings->get('hero_book_1_link', '/koleksi'),
            ],
            'book_2' => [
                'image' => $heroSettings->get('hero_book_2_image', '/images/cover-2.jpg'),
                'title' => $heroSettings->get('hero_book_2_title', 'Buku Modul PERKEMI 2'),
                'link' => $heroSettings->get('hero_book_2_link', '/koleksi'),
            ],
            'book_3' => [
                'image' => $heroSettings->get('hero_book_3_image', '/images/cover-3.jpg'),
                'title' => $heroSettings->get('hero_book_3_title', 'Buku Utama Kurikulum PERKEMI'),
                'link' => $heroSettings->get('hero_book_3_link', '/koleksi'),
            ],
        ];
    ...
    public function categoriesIndex(): Response
    {
        ...
        $categories = Category::where('is_active', true)
            ...
            ->orderByRaw('COALESCE(sort_order, 999) asc')
            ->orderBy('name')
            ->get()
            ->values()
            ->map(function (Category $c, int $idx) use ($categoryColors) {
                ...
                return [
                    ...
                    'published_count' => (int) $c->published_count,
                ];
            });
