    ...
    public function data(User $user, string $slug): array
    {
        ...
        return [
            ...
            'event' => [
                ...
                'responsible_user_name' => $event->responsibleUser?->name,
            ...
            'participant' => [
                ...
                'origin_province' => $participant->origin_province,
                'origin_city' => $participant->origin_city,
                'dojo' => $participant->dojo,
                'origin_dojo' => $participant->origin_dojo,
                ...
                'id_card_url' => route('event.id-card.mine', $event->slug),
            ],
