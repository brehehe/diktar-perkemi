        ...
        <header className="h-16 bg-white border-b border-[#DCE7F3] px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 select-none">
            ...
            <div className="flex items-center gap-3">
                <button
                    ...
                    className="md:hidden p-2 rounded-lg text-[#6B7C93] hover:text-[#112743] hover:bg-[#EAF5FF]"
                >
            ...
            <div className="flex items-center gap-3">
                <DropdownMenu
                    trigger={
                        <button
                            type="button"
                            className="flex items-center gap-2.5 p-1.5 rounded-lg hover:bg-[#F8FBFF] border border-transparent hover:border-[#DCE7F3] transition-colors focus:outline-none"
