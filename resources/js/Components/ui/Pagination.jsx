                ...
                <div className="flex items-center gap-1">
                    ...
                    {prev_page_url ? (
                        <Link
                            ...
                            preserveState
                            preserveScroll
                            className="inline-flex min-h-10 items-center gap-1 px-2.5 py-1.5 rounded-md border border-[#DCE7F3] text-[#112743] hover:bg-[#F8FBFF] hover:border-[#0B63CE]/40 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B63CE] motion-reduce:transition-none"
                        ...
                        <span className="inline-flex min-h-10 items-center gap-1 px-2.5 py-1.5 rounded-md border border-[#DCE7F3]/40 text-[#6B7C93]/40 cursor-not-allowed" aria-disabled="true">
                            <ChevronLeft className="w-3.5 h-3.5" />
                            <span className="hidden sm:inline">Sebelumnya</span>
                        </span>
                    )}
                        ...
                        {links.slice(1, -1).map((link, idx) => {
                            ...
                            return (
                                <Link
                                    ...
                                    preserveScroll
                                    className={`
                                        min-w-10 h-10 flex items-center justify-center rounded-md border text-xs font-medium transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B63CE] motion-reduce:transition-none
