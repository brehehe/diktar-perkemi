...
const Textarea = forwardRef(function Textarea(
    ...
    const inputId = id || name || `textarea-${Math.random().toString(36).substring(2, 9)}`;
    ...
    return (
        <div className="w-full">
            ...
            <textarea
                ...
                className={`
                    w-full rounded-lg bg-white border text-sm text-[#112743] placeholder-[#6B7C93]/60 px-3.5 py-2.5 transition-all duration-150 resize-y
