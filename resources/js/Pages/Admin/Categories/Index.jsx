            ...
            >
                <form onSubmit={handleCreateSubmit} className="space-y-4">
                    ...
                    <Input
                        ...
                        placeholder="perwasitan-nasional"
                        helperText="Opsional. Jika kosong, slug dibuat otomatis dari nama kategori."
                        ...
                        <div className="flex items-center gap-2 mb-2">
                            {PRESET_COLORS.map((c) => (
                                <button
                                    ...
                                    className={`inline-flex size-11 items-center justify-center rounded-lg transition-colors motion-reduce:transition-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B63CE] ${createForm.data.color === c ? 'bg-[#EAF5FF]' : 'hover:bg-[#F8FBFF]'}`}
                                    aria-label={`Pilih warna ${c}`}
                                    aria-pressed={createForm.data.color === c}
                                >
                                    <span className={`size-6 rounded-full border ${createForm.data.color === c ? 'ring-2 ring-[#0B63CE] ring-offset-2' : 'border-transparent'}`} style={{ backgroundColor: c }} aria-hidden="true" />
                                </button>
                            ))}
                        </div>
                        <Input
            ...
            >
                <form onSubmit={handleEditSubmit} className="space-y-4">
                    ...
                    <Input
                        ...
                        placeholder="perwasitan-nasional"
                        helperText="Slug menentukan alamat /kategori/slug. Perubahan akan mengganti URL kategori publik."
                        required
                        ...
                        <div className="flex items-center gap-2 mb-2">
                            {PRESET_COLORS.map((c) => (
                                <button
                                    ...
                                    className={`inline-flex size-11 items-center justify-center rounded-lg transition-colors motion-reduce:transition-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0B63CE] ${editForm.data.color === c ? 'bg-[#EAF5FF]' : 'hover:bg-[#F8FBFF]'}`}
                                    aria-label={`Pilih warna ${c}`}
                                    aria-pressed={editForm.data.color === c}
                                >
                                    <span className={`size-6 rounded-full border ${editForm.data.color === c ? 'ring-2 ring-[#0B63CE] ring-offset-2' : 'border-transparent'}`} style={{ backgroundColor: c }} aria-hidden="true" />
                                </button>
                            ))}
                        </div>
                        <Input
