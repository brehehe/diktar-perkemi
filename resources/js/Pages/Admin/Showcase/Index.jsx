            ...
            >
                <div className="flex items-center gap-2.5">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-[#0B63CE] bg-white border border-[#BCE0FD] rounded-lg hover:bg-[#EAF5FF] transition-colors shadow-xs"
                    >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="space-y-2 flex-1 min-w-0">
                                                <label className="cursor-pointer inline-flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold text-[#0B63CE] bg-[#EAF5FF] hover:bg-[#BCE0FD]/50 border border-[#BCE0FD] transition-colors w-full justify-center">
